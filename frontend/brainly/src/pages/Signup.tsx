const Signup = () => {
    return (
        <div className=" h-screen w-screen bg-slate-950 flex flex-col gap-4 items-center justify-center">
            ...
            <div className=" bg-slate-100 flex flex-col items-center justify-center gap-4  rounded-lg p-4">
                ...
                <button className=" p-3 bg-slate-950 text-white font-semibold rounded-lg">Signup</button>
            </div>
